...
using Sitecore.Shell.Applications.Dialogs.AnchorLink;
...
namespace Sitecore.Sbos.Module.LinkTracker.sitecore.shell.Applications.Dialogs.AnchorLink
{
    public class TrackedAnchorLink : AnchorLinkForm
    {
