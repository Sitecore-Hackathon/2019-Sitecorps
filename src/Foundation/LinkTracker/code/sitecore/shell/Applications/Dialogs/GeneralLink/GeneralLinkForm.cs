...
using System.Xml;
using static Sitecore.Sbos.Module.LinkTracker.Data.Constants.LinkTrackerConstants;

namespace Sbos.Foundation.LinkTracker.sitecore.shell.Applications.Dialogs.GeneralLink
{
    public class GeneralLinkForm : LinkForm
    {
        ...
        {
            Context.ClientPage.ClientScript.RegisterClientScriptBlock(Context.ClientPage.GetType(), "translationsScript", "window.Texts = {{ ErrorOcurred: \"{0}\"}};".FormatWith((object)Translate.Text("An error occured:")), true);
        }
        ...
        protected virtual void reload()
        {
            ...
            string[] PathElement = new string[3];
            ...
            for (int i = 1; i <= 2; i++)
            {
                ...
                if (ItemsOn != null)
                {
                    ...
                    xdoc.Load(webRooPath + Sitecore.Sbos.Module.LinkTracker.Data.Constants.LinkTrackerConstants.GeneralFormPath);
        ...
        private string GetWebRootPath(string assembly)
        {
            ...
            if (!string.IsNullOrEmpty(assemblyLoc))
            {
                ...
                string webRootPath = assemblyLoc.Replace(Sitecore.Sbos.Module.LinkTracker.Data.Constants.LinkTrackerConstants.AssemblyLinkTrackerPath,
                    "");
